...
Jednoduchá funkce, která v případě režimu ladění, který lze zapnout v hlavičce, odesílá informace o veškerém dění do připojeného počítače. Na vstupu obdrží textový retězec, který pouze po seriové lince pošle do předem definovaného zařízení. Funkce je volána z každé funkce v kódu a jedná se o jediný možný způsob ladění.
