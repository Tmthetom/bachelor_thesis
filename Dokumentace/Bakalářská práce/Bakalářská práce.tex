...
\chapter{Úvod}
Podnětem vytvoření této práce mi byl můj vlastní zájem o sledovací zařízení do vozidla, kdy jsem pátral po levném, kvalitním a jednoduše ovladatelném zařízení, které naplní moje požadavky. Nejdříve jsem provedl průzkum českého trhu, načež jsem zjistil, že zařízení, která splňují mé požadavky, jsou cenově odhodnoceny kolem 8 000 Kč, protože všeobecně platí, že zařízehí z dovozu jsou někdy i o polovinu levnější, rozhodl jsem se pro nákup z Číny. První zařízení za 500 Kč, který i přes oficiální infomrace o funkčnosti po celém světě, nebyl v české republice funkční, protože mapové podklady na Evropu nebyly připraveny a odpovědi SMS chodili v čínském jazyce, nebylo možné jej přepnout, stejně tak manuál byl čínsky. Další pokus nastal se zařízením za 1 000 Kč, mapové podklady byly tentokrát přes mapy Google, byli tedy funkční. Zařízení ale v SMS odpovídalo špatně srozumitelnými textovými řetězci, přesnost na stovky metrů byla nedostatečná a poloha byla tedy učena vždy o několik ulic vedle. Řekl jsem si musí to jít přeci udělat lépe a rozhodl jsem se pro výrobu svého vlastního sledovacího zařízení, které by za peníze, které běžně stojí ty nejlevnější modely sledovacích zařízení, poskytovalo vlastnosti zařízení, která se nachází v daleko vyšších cenových relacích. Není to marné snažení a je to možné. Abych byl lépe motitován a hnán kupředu k dokončení své práce, rozhodl jsem se první etapu, tedy vytvoření funkčního prototypu a návrhu programové části, vytvořit v rámci své bakalářské práce.
...
Hotový prototyp jsem po otestování podrobil měření spotřeby, ve všech možných režimech. Měření probíhalo při pokojové teplotě 22 \degree C. Při výpočtech spotřeby, počítám s nejslabší možnou autobaterií o kapacitě 50 Ah. Dny jsou zaokrouhlovány vždy dolů, na celý jeden den. Po měření jsem zjistil, že nyní zařízení teorieticky vydrží na nedobíjenou autobaterii přibližně 30 dnů a při správné implementaci zdrojových kódů akcelerometru, do zdrojových kódů řídící jednotky, které jsem již zhotovill, je možné dosáhnout teoretické výdrže až 200 dní. V případě vybité baterie, by bylo vhodné uživatele notifikovat o tomto stavu.
...
\hline
Režim & Spotřeba & Výdrž hodin & Výdrž dní\\
\hline
\hline
GSM & 150 mA & 333 & 13\\
\hline
...
\end{tabular}
\end{center}
\caption{Naměřená spotřeba prototypu}
\end{table}
...
\bibitem{what}What is a GPS? How does it work? Library of congress [online]. [cit. 2016-05-09]. Dostupné z: http://www.loc.gov/rr/scitech/mysteries/global.html
\bibitem{guide}A Guide To The Global Positioning System. Radioshack [online]. [cit. 2016-05-09]. Dostupné z: http://support.radioshack.com/support\_tutorials/gps/gps\_tmline.htm
\bibitem{glonass}DALY, P. Navstar GPS and GLONASS [online]. 1993 [cit. 2016-05-09]. Dostupné z: http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=285510
...
\bibitem{gpsCommon}Global Positioning System. Wikipedia [online]. [cit. 2016-05-09]. Dostupné z: https://en.wikipedia.org/wiki/Global\_Positioning\_System
...
\bibitem{correct}BYRNE, Jonathan. Position error with GPS/GSM v3. In: Dfrobot [online]. [cit. 2016-05-09]. Dostupné z: http://www.dfrobot.com/forum/viewtopic.php?f=2\&t=1528\&p=7729 \#p7693
\bibitem{geographic}Geographic coordinate system. Wikipedia [online]. [cit. 2016-05-09]. Dostupné z: https://en.wikipedia.org/wiki/Geographic\_coordinate\_system
