...
Pokud byla obdržena nová SMS, očekává se přijetí, její hlavičky. Pokud tak nastane, je z hlavičky vyčteno telefonní číslo odesílatele, na které bude následně odeslána odpověď SMS. Číslo je uloženo do globální proměnné. Funkce pracuje s globálními proměnnými a nevrací žádný výstup.
