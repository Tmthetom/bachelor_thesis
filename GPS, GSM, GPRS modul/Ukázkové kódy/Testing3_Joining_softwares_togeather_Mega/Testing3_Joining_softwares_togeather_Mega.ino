// Internal variables
const byte gsmDriverPin[3] = {3,4,5};  // Pins of GPS
const int networkConnect = 1000;  // In real case, highly recommended bigger amount of time
const int baudRate = 9600;  // Communication baud rate for GPS and PC
const int common = 500;  // Delay between commands
...
void setup(){
  ...
  Serial1.begin(baudRate);  // Connect with GPS (GPS/GPRS/GSM Module v3.0)
